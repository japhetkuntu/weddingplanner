namespace Ovutor.Storage.Sdk.Configuration;
...
public sealed class StorageSettings
{
    ...
    public string CdnEndpoint { get; set; } = string.Empty; // e.g. cdn.ovutor.com, or the MinIO endpoint locally
    ...
    /// <summary>Prefixed onto every object key (e.g. "ovutor") — lets one Spaces bucket be
