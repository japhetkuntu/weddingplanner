...
public record WebsiteImage(string? Url, string Label);
...
public record WebsiteRsvpConfig(string Deadline, string ConfirmationMessage, bool CollectDietary, bool CollectPlusOne);
