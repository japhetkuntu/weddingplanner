...
/** A couple's own published wedding site — everything that used to be the whole app before the
 * ovutor.com marketing site (Home/About/Services/Journal/Contact) was added alongside it. Now
 * mounted at the catch-all `/:slug` route, so any path that isn't one of the reserved marketing
 * routes falls through to a slug lookup here, exactly like the old pathname-based behavior did. */
  ...
  if (error || !site) {
    return (
      <OvutorLanding
        ...
        message="This link may be outdated, or the site may have moved. Double-check the link your couple shared with you."
      />
    );
  }
