 ...
 * line. Kept on the same gold tone as the hero section below it, so the eventual cross-fade
 * into the real page feels continuous rather than a jarring background swap. */
export function WeddingLoader() {
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-gold">
      <div className="flex flex-col items-center px-6 text-center">
        ...
        <p
          className="ovutor-fade-in mt-6 font-display text-2xl italic text-ink"
          style={{ animationDelay: "0.3s" }}
        >
          You&rsquo;re invited
        </p>
        <div
          className="ovutor-fade-in mt-4 h-px w-16 bg-ink/25"
          style={{ animationDelay: "0.6s" }}
        />
        <p
          className="ovutor-fade-in mt-4 text-[10px] font-bold uppercase tracking-[.2em] text-ink/50"
